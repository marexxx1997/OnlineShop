...
namespace OnlineShop.Data.Services
{
    public class OrdersService : IOrdersService
    {
        ...
        {
            var orders = await _context.Orders.Include(n => n.OrderItemsNew).ThenInclude(n => n.Laptop).Include(n => n.OrderItemsNew).ThenInclude(n => n.Component).Include(n => n.User).ToListAsync();
